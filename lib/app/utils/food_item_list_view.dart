              ...
              child: Column(
                ...
                children: [
                  ...
                  InkWell(
                    ...
                    child: SvgPicture.asset(ImageAssets.bell,
                        color: AppColor.whiteColor),
                  ),
                  const SizedBox(height: 15),
                  InkWell(
                    ...
                    child: SvgPicture.asset(ImageAssets.task,
                        color: AppColor.whiteColor),
                  ),
                ],
              ),
          ...
          children: [
                  ...
                  return Obx(() => Container(
                    ...
                    child: ListTile(
                      ...
                      title: Column(
                        crossAxisAlignment: CrossAxisAlignment.start,
                        children: [
                          Text(foodItems[index]['name']!, style: _textStyle()),
                          Text(foodItems[index]['price']!, style: _textStyle()),
                          Text('Time: ${foodItems[index]['time']!}',
                              style: _textStyle()),
                        ],
                      ),
                      trailing: InkWell(
            ...
            Padding(
              ...
              child: Obx(() => SizedBox(
                ...
                height: scrollIndicatorHeight,
                child: CustomPaint(
                  // This key forces CustomPaint to rebuild with a new painter
